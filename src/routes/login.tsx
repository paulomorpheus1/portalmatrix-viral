...
function LoginRouteComponent() {
  ...
  useEffect(() => {
    // Monitora aURL para capturar o hash de autenticação do Google instantaneamente
    ...
    // Escuta global de eventos de autenticação do Supabase
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="glass rounded-xl p-8 max-w-md w-full relative z-10 neon-border border border-muted">
        ...
        <Button 
          type="button" 
          variant="outline" 
          className="w-full mb-6 py-5 font-medium transition-all hover:bg-muted" 
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div>
            ...
            <input 
              type="email" 
              className="w-full bg-background border border-muted rounded p-2.5 text-sm focus:outline-none focus:ring-1 focus:ring-accent"
              value={email}
